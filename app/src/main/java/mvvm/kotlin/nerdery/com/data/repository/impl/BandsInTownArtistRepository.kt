package mvvm.kotlin.nerdery.com.data.repository.impl

import android.content.SharedPreferences
import kotlinx.coroutines.*
import mvvm.kotlin.nerdery.com.constants.CacheKey
import mvvm.kotlin.nerdery.com.data.api.BandsInTownApi
...
import mvvm.kotlin.nerdery.com.data.repository.base.BaseRepository
import mvvm.kotlin.nerdery.com.data.repository.base.Resource
import mvvm.kotlin.nerdery.com.data.repository.helpers.DataFetchHelper
    ...
    override suspend fun getArtistByName(name: String): Deferred<Resource<Artist?>> {
        val dataFetchHelper = object : DataFetchHelper.LocalFirstUntilStale<Artist?>(
            ...
            override suspend fun convertApiResponseToData(response: Response<out Any?>): Artist {
                return Artist().reflectFrom(response.body() as ArtistResponse)
            }
