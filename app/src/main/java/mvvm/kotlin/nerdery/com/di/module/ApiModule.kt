...
import mvvm.kotlin.nerdery.com.data.api.interceptor.BandsInTownInterceptor
...
class ApiModule {
    ...
    @Singleton
    @Provides
    fun providesBandsInTownInterceptor(): BandsInTownInterceptor = BandsInTownInterceptor()
