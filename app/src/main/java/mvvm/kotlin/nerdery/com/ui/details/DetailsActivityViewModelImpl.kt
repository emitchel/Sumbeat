    ...
    private suspend fun fetchArtistDetails(artistName: String) {
        ...
        when {
            ...
            artistDetailsResource.isNetworkIssue() -> {
                mutableArtistDetails.value = StatefulResource<Artist?>().apply {
            ...
            else -> mutableArtistDetails.value = StatefulResource<Artist?>().apply {
        ...
        artist?.let {
            ...
            when {
                ...
                artistEventDetails.isNetworkIssue() -> {
                    mutableArtistEventDetails.value = StatefulResource<List<EventWithArtist>?>().apply {
                        setMessage(R.string.no_network_connection)
                        setState(StatefulResource.State.ERROR_NETWORK)
                    }
                }
                ...
                else -> mutableArtistEventDetails.value = StatefulResource<List<EventWithArtist>?>().apply {
                    setState(StatefulResource.State.SUCCESS)
                    setMessage(R.string.artist_not_found)
                }
            }
