...
import mvvm.kotlin.nerdery.com.ui.SingleLiveEvent
...
@Inject constructor(
    ...
    private val mutableArtistSearch: SingleLiveEvent<StatefulResource<Artist?>> = SingleLiveEvent()
        ...
        launch {
            ...
            when {
                ...
                resource.isNetworkIssue() -> {
                    mutableArtistSearch.value = StatefulResource<Artist?>().apply {
                ...
                else -> mutableArtistSearch.value = StatefulResource<Artist?>().apply {
